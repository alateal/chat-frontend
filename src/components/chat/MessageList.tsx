...
import { UserStatus, Message, User, FileAttachment } from '../../types';
...
const MessageList = ({ 
  ...
  const [selectedParentMessageId, setSelectedParentMessageId] = useState<string | null>(null);
  ...
  return (
    <div className="flex-1 flex overflow-hidden">
                  ...
                  <div className="relative flex-1">
                    ...
                    >
                      ...
                      {FREQUENT_EMOJIS.map((emoji) => {
                        ...
                        const hasReacted = existingReaction && userId  // Get userId from props
      ...
      <div className={`
        w-96 bg-base-100 border-l border-base-300 transition-all duration-300 ease-in-out
        ${showThread ? 'translate-x-0' : 'translate-x-full'}
        fixed top-0 right-0 bottom-0 z-50 overflow-hidden
      `}>
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="p-4 border-t border-base-300">
              <MessageInput 
                ...
                users={users}
                onSendMessage={(content) => handleSendReply(content)}
